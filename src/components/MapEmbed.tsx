  ...
  return (
    ...
    >
      ...
      <div className="relative border-b border-gray-100 bg-gray-50 px-5 py-6 md:px-8 md:py-7">
        <div className="absolute top-0 right-0 h-28 w-28 rounded-full bg-accent-yellow/10 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 h-28 w-28 rounded-full bg-accent-red/10 blur-3xl pointer-events-none" />
            ...
            >
              <div className="mb-1">
                ...
                <p className="mt-1 text-sm md:text-base text-gray-500">
                  Enter your project details to get an approximate steel estimate.
                </p>
              </div>
                  ...
                  {estimatedSteel !== null ? (
                    <div className="text-center md:text-left w-full">
                      ...
                      <p className="mt-2 text-xs md:text-sm text-gray-500">
                        Approximate value based on standard industry ratios.
                      </p>
                    </div>
                  ) : (
          ...
          {activeTab === "weight" && (
            ...
            >
              <div className="mb-1">
                ...
                <p className="mt-1 text-sm md:text-base text-gray-500">
                  Find bar weight and approximate bundle count instantly.
                </p>
              </div>
