    ...
    <section className="relative w-full bg-[#f8f9fa] py-16 md:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12 flex flex-col md:flex-row items-center gap-12">
        ...
        <motion.div
          ...
          className="w-full md:w-[48%] flex flex-col items-start"
        >
          <div className="flex items-center gap-6 mb-8 flex-wrap">
            ...
            <div className="hidden md:block h-10 w-[2px] bg-gray-300" />
          ...
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-[0.95] font-black uppercase text-gray-800 mb-2">
            Officially
          </h2>
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-[0.95] font-black uppercase text-[#3b8226] mb-6">
            Certified
          </h2>

          <h3 className="font-body text-xl md:text-2xl font-medium text-gray-800 mb-4 leading-tight">
          ...
          <p className="font-body text-gray-800 text-sm md:text-base leading-relaxed">
            Thank you for trusting Kaaveri. Together,
            <br />
            we build responsibly.
          </p>
        </motion.div>

        {/* Right Side: Full Certificate Image */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
          className="w-full md:w-[52%] flex justify-center"
        >
